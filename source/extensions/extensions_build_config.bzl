...
EXTENSIONS = {
    ...
    "envoy.filters.http.cache2":                        "//source/extensions/filters/http/cache2:config",
    "envoy.filters.http.cache_rqc":                     "//source/extensions/filters/http/cache_rqc:config",
    ...
    "envoy.filters.http.request_coalescing":            "//source/extensions/filters/http/request_coalescing:config",
    "envoy.filters.http.router":                        "//source/extensions/filters/http/router:config",
    "envoy.filters.http.rqc":                           "//source/extensions/filters/http/rqc:config",
    ...
    "envoy.extensions.http.cache.ring_buffer":          "//source/extensions/http/cache/ring_buffer_http_cache:config",
